...
class TestIntegrationWithRealFiles:
    ...
    def test_capybaradb_with_real_txt_file(self, mock_logger, mock_embedding_model, txt_file):
    ...
    @patch('capybaradb.main.EmbeddingModel')
    @patch('capybaradb.main.setup_logger')
    def test_capybaradb_with_chunking_real_file(self, mock_logger, mock_embedding_model, txt_file):
        mock_logger.return_value = Mock()
        mock_model = Mock()
        mock_embedding_model.return_value = mock_model
    ...
    @patch('capybaradb.main.EmbeddingModel')
    @patch('capybaradb.main.setup_logger')
    def test_capybaradb_multiple_documents(self, mock_logger, mock_embedding_model, txt_file, pdf_file, docx_file):
        mock_logger.return_value = Mock()
        mock_model = Mock()
        mock_embedding_model.return_value = mock_model
        mock_model.embed.return_value = torch.randn(1, 384)
        mock_model.search.return_value = (torch.tensor([0, 1, 2]), torch.tensor([0.9, 0.8, 0.7]))
    ...
    @patch('capybaradb.main.EmbeddingModel')
    @patch('capybaradb.main.setup_logger')
    def test_capybaradb_precision_modes(self, mock_logger, mock_embedding_model, txt_file):
        mock_logger.return_value = Mock()
    ...
    @patch('capybaradb.main.EmbeddingModel')
    @patch('capybaradb.main.setup_logger')
    def test_capybaradb_document_retrieval(self, mock_logger, mock_embedding_model, txt_file):
        mock_logger.return_value = Mock()
        mock_model = Mock()
        mock_embedding_model.return_value = mock_model
        mock_model.embed.return_value = torch.randn(1, 384)
